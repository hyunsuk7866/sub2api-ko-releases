...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/hyunsuk7866/sub2api-ko-releases/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="hyunsuk7866/sub2api-ko-releases"
...
Documentation=https://github.com/hyunsuk7866/sub2api-ko-releases
